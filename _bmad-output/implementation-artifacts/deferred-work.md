...
- source_spec: `_bmad-output/implementation-artifacts/spec-19-11-la-numeracion-de-verso-no-se-versiona.md`
  ...
  **RESUELTO el 14/09: auditados los 306.** Pedida a la Fuente la página de los 306 documentos de Wikisource-es versionados, en lotes de 10, sin un solo error. Solo La Eneida de Ochoa, libro I, trae `<sup>` sin atributos de solo cifras (86), y su cuerpo versionado es palabra a palabra el que da hoy la regla (8.589 palabras): una re-recuperación no cambiaría nada. Tampoco hay en ninguno variantes fuera de la regla: `<sup>` de cifras con atributos o con marcado dentro, de cinco cifras o más, con punto, ni superíndices Unicode. Los otros `<sup>` sin atributos del Corpus son las flechas de vuelta de la lista de notas («12,0», «12,1» en los doce Soliloquios, con enlace dentro) y una llamada «[14]» del Manual sobre el ejército que no llega al texto: ninguno es numeración y la regla no los toca.
- source_spec: `_bmad-output/implementation-artifacts/spec-19-11-la-numeracion-de-verso-no-se-versiona.md`
